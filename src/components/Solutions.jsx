  ...
  return (
    <>
      <section className= 'bg-[#093157]'>
        ...
        <div 
              ref={ref1}
              className={`flex flex-col gap-3 mx-6 my-4 p-10 cursor-pointer ${isVisible1 ? "opacity-100" : "opacity-0"} bg-white shadow-lg shadow-[#4c91be] g-blue-500 transition ease-in-out delay-150 g-blue-500 hover:-translate-y-1 hover:scale-110 duration-500 `} >
            ...
            <div 
              ref={ref2}
              className={`flex flex-col gap-3 mx-6 my-4 p-10 cursor-pointer ${isVisible2 ? "opacity-100" : "opacity-0"} bg-white shadow-lg shadow-[#4c91be] text-gray-700 g-blue-500 transition ease-in-out delay-150 g-blue-500 hover:-translate-y-1 hover:scale-110 duration-300`} >
              <div className="flex gap-5">
            ...
            <div 
              ref={ref3}
              className={`flex flex-col gap-3 mx-6 my-4 p-10 cursor-pointer ${isVisible3 ? "opacity-100" : "opacity-0"} bg-white shadow-lg shadow-[#4c91be] text-gray-700 g-blue-500 transition ease-in-out delay-150 g-blue-500 hover:-translate-y-1 hover:scale-110 duration-300`} >
              <div className="flex gap-5">
            ...
            <div 
              ref={ref4}
              className={`flex flex-col gap-3 mx-6 my-4 p-10 cursor-pointer ${isVisible4 ? "opacity-100" : "opacity-0"} bg-white shadow-lg shadow-[#4c91be] text-gray-700 g-blue-500 transition ease-in-out delay-150 g-blue-500 hover:-translate-y-1 hover:scale-110 duration-300`} >
             <div
              ref={ref4}
              className="flex gap-5">
               <img
               className={`w-16  h-16 my-auto ${isVisible4 ? "animate-slide-out-right" : ""}`}
               src={consultant} alt="" width={40}/>
              <h4 className="text-gray-800 font-semibold text-[20px] lg:text-2xl py-1"> 
